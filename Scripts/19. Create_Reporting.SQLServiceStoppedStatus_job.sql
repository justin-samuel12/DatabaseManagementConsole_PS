...
/********************* VARIABLES *******************************/
	...
	DECLARE @ObjectName varchar(256) = '$(Database_Name).Reporting.SQLServiceStoppedStatus';
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'''+ @ObjectName +''', 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N''Reporting on all failed SQL services. Run every 1 hr'', 
		@category_name=N''Database Maintenance'', 
		@owner_login_name=N''sa'', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Execution]    Script Date: 9/24/2014 8:19:34 PM ******/
...
go
exec [Reporting].[usp_SQLServiceStoppedStatus_Get]'', 
